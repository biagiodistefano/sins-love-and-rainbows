...
ALLOWED_HOSTS = (
    [
        "127.0.0.1",
        "localhost",
        "sinsloveandrainbows.com",
        "www.sinsloveandrainbows.com",
        "api.sinsloveandrainbows.com",
        "sinsloveandrainbows.eu",
        "www.sinsloveandrainbows.eu",
        "api.sinsloveandrainbows.eu",
    ]
    if not DEBUG
    else ["*"]
)
